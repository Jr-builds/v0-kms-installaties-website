        ...
        <div className="flex flex-row items-center justify-center divide-x divide-gray-300">
          {[trustLinks.googleReviews, trustLinks.werkspot].map((item) => (
            <a
              ...
              className="flex flex-1 items-center justify-center gap-2 rounded-md px-2 py-2 transition-colors hover:bg-white/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-kms-navy sm:flex-none sm:px-5"
            >
